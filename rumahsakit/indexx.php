...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a style="background-color:#EECAB2;" class="navbar-brand" href="#myPage">S.HOSPITAL</a>
      </div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <a href="https://covid19.go.id/peta-sebaran"><img src="slider1.png" alt="iklan" style="width:100%;"></a>
        </div>
        <div class="item">
          <img src="slider2.png" alt="iklan" style="width:100%;">
        </div>
        <div class="item">
          <a href="https://covid19.go.id/p/berita/gugus-tugas-covid-19-sudah-distribusikan-1492150-apd"><img src="slider3.png" alt="iklan" style="width:100%;"></a>
        </div>
      </div>
  ...
  <div id="contact" class="container-fluid bg-grey" style="border-radius: 20px;background-color: var(--bg); margin-left: 30px; margin-right: 30px">
    <h2 class="text-center">MEMBERS OF RESTU IBU</h2>
    <!-- CONTAINER GRID LUCUKK WEEYY -->
    <div class="tim">
      <div class="info">
  ...
  <footer>
      <div class="footer-container">
        <div class="right-col">
          ...
          <p style="color: grey" class="center-text">© 2020 Created By <b>RESTU IBU</p>
        </div>
      </div>
    </footer>
  </body>
