...
<head>
    <?php
      ...
      $pasien = mysqli_query($con, "SELECT * FROM tb_pasien");
        ...
        <div id="sidebar-wrapper" style="background-color: #EECAB2; font-size: 15px; font-family: Lato, sans-serif;">
            <ul class="sidebar-nav">
                <li class="sidebar-brand">
                    <a href="<?= base_url('dashboard'); ?>"><strong style="color: black; font: 200 25px Lato, sans-serif;letter-spacing: 4px;"> S.HOSPITAL</strong></a>
                </li>
                <li>
                ...
                <li>
                    <a href="<?= base_url('poliklinik/data.php') ?>" style="color: black"><p class="fas fa-clinic-medical"></p>&emsp;Data Poliklinik</a>
                </li>
                <li>
                    <a href="<?= base_url('obat/data.php') ?>" style="color: black"><p class="fas fa-tablets"></p>&emsp;Data Obat</a>
                </li>
                <li>
                    <a href="<?= base_url('rekammedis/data.php') ?>" style="color: black"><p class="fas fa-notes-medical"></p>&emsp;Rekam Medis</a>
                </li>
                <li>
